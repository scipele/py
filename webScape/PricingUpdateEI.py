...
if response.status_code == 200:
    ...
    # Initialize a List to hold all the product data
    product_data = []
    
    # Initialize a List to hold all the product data groups
    product_groups = []
    ...
    for index, group_name in enumerate(product_groups):
        ...
        for product in product_rows:
            ...
            data_id = product.find('div', class_='product-item-info')['data-id'] if product.find('div', class_='product-item-info') else "N/A"
